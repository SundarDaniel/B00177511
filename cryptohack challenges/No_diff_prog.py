...
# connects to a server and sends two datasets, after proceccing then through per() and sub()
# functions. The datasets are converted into hexadecimal and sent to server in json format.
# it recieves and prints the respones.