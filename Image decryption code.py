...
class ECBImageProcessor:
    def __init__(self, img_path, block_size=16, max_colors=254, flip=True, pixels_per_block=16):
    ...
    def create_image(self, pixel_colors):
        ...
        output_image_path = f"{self.img_path}_image.png"
...
if __name__ == "__main__":
    ...
    parser.add_argument("img_path", help="Path to the encrypted image file")
